    ...
    <main className="relative z-10 pt-28 pb-20 px-6 max-w-3xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
        <ClayCard>
          ...
          {[
            { title: '1. Information We Collect', body: 'When you use the contact form on this portfolio site, we collect your name, email address, and message. No other personal data is collected or stored.' },
            { title: '2. How We Use Your Information', body: 'Your contact information is used solely to respond to your enquiry. We do not sell, share, or distribute your data to any third parties.' },
            ...
            { title: '4. Third-Party Links', body: 'This portfolio links to external client projects. We are not responsible for the privacy practices of those external websites.' },
